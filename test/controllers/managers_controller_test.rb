...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post managers_url, params: { manager: { firstname: @manager.firstname, lastname: @manager.lastname, team_id: @manager.team_id } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { firstname: @manager.firstname, lastname: @manager.lastname, team_id: @manager.team_id } }
