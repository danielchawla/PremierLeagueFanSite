...
t8.players.create(firstname: 'Willy', lastname: 'Caballero', nationality: 'Argentina', position: 'Goalkeeper', yearsofexperience: '3', salary: '300000') 
t8.players.create(firstname: 'Robert', lastname: 'Green', nationality: 'England', position: 'Goalkeeper', yearsofexperience: '5', salary: '510000') 
t8.players.create(firstname: 'Marcin', lastname: 'Bulka', nationality: 'Poland', position: 'Goalkeeper', yearsofexperience: '2', salary: '250000') 
t8.players.create(firstname: 'Antonio', lastname: 'Rudiger', nationality: 'Germany', position: 'Defender', yearsofexperience: '0', salary: '100000') 
t8.players.create(firstname: 'Marcos', lastname: 'Alonso', nationality: 'Spain', position: 'Defender', yearsofexperience: '3', salary: '490000') 
t8.players.create(firstname: 'Davide', lastname: 'Zappacosta', nationality: 'Italy', position: 'Defender', yearsofexperience: '9', salary: '990000') 
t8.players.create(firstname: 'Andreas', lastname: 'Christensen', nationality: 'Denmark', position: 'Defender', yearsofexperience: '5', salary: '521000') 
t8.players.create(firstname: 'Ruben', lastname: 'Logtus-Cheek', nationality: 'England', position: 'Midfielder', yearsofexperience: '2', salary: '200000') 
t8.players.create(firstname: 'Mateo', lastname: 'Kovacic', nationality: 'Croatia', position: 'Midfielder', yearsofexperience: '2', salary: '355000') 
t8.players.create(firstname: 'George', lastname: 'McEachran', nationality: 'England', position: 'Midfielder', yearsofexperience: '1', salary: '200000') 
t8.players.create(firstname: 'Eden', lastname: 'Hazard', nationality: 'Belgium', position: 'Midfielder', yearsofexperience: '3', salary: '300000') 
t8.players.create(firstname: 'Olivier', lastname: 'Giroud', nationality: 'France', position: 'Forward', yearsofexperience: '6', salary: '620000') 
t8.players.create(firstname: 'Callum', lastname: 'Hudon-Odoi', nationality: 'England', position: 'Forward', yearsofexperience: '2', salary: '150000') 
t8.players.create(firstname: 'Pedro', lastname: 'Willian', nationality: 'Brazil', position: 'Forward', yearsofexperience: '2', salary: '210000') 
t8.players.create(firstname: 'Gonzalo', lastname: 'Higuain', nationality: 'Argentina', position: 'Forward', yearsofexperience: '7', salary: '920000') 
